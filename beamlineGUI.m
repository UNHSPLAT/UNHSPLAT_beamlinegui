classdef beamlineGUI < handle
    ...
    properties
        ...
        hVsetGrp % Handle to pressures and Vset status uicontrol group
        ...
        hBeamlineP % Overlay for beamline pressure
        hChamberP % Overlay for chamber pressure
        hRoughlineP % Overlay for roughing line pressure
        hBeamlinePunit % torr
        hChamberPunit % torr
        hRoughlinePunit % torr
    end
    ...
    methods (Access = private)
        ...
        function createGUI(obj)
            ...
            % initiating VsetGrp panel
            obj.hVsetGrp = uipanel(obj.hFigure,...
                'Title','Voltage Set',...
                'FontWeight','bold',...
                'FontSize',14,...
                'Units','pixels',...
                'Position',[20,10,540,175]);
            
            ypos = ypos-ysize-ygap;

            obj.hMassText = uicontrol(obj.hVsetGrp,'Style','text',...
                'Position',[xpos,ypos,xsize,ysize],...
                'String','Mass flow',...
                'FontWeight','bold',...
                'FontSize',12,...
            ...
            obj.hExbText = uicontrol(obj.hVsetGrp,'Style','text',...
                'Position',[xpos,ypos,xsize,ysize],...
                'String','ExB',...
                'FontWeight','bold',...
                'FontSize',12,...
            ...
            obj.hEsaText = uicontrol(obj.hVsetGrp,'Style','text',...
                'Position',[xpos,ypos,xsize,ysize],...
                'String','ESA',...
                'FontWeight','bold',...
                'FontSize',12,...
            ...
            obj.hDeflText = uicontrol(obj.hVsetGrp,'Style','text',...
                'Position',[xpos,ypos,xsize,ysize],...
                'String','Defl',...
                'FontWeight','bold',...
                'FontSize',12,...
            ...
            obj.hYsteerText = uicontrol(obj.hVsetGrp,'Style','text',...
                'Position',[xpos,ypos,xsize,ysize],...
                'String','y-steer',...
                'FontWeight','bold',...
                'FontSize',12,...
            ...
            obj.hMassReadText = uicontrol(obj.hVsetGrp,'Style','text',...
                'Position',[xpos,ypos,xsize,ysize],...
                'String','Voltage [V]: ',...
                'FontSize',12,...
                'HorizontalAlignment','right');
            ...
            obj.hExbReadText = uicontrol(obj.hVsetGrp,'Style','text',...
                'Position',[xpos,ypos,xsize,ysize],...
                'String','Voltage [V]: ',...
                'FontSize',12,...
                'HorizontalAlignment','right');
            ...
            obj.hEsaReadText = uicontrol(obj.hVsetGrp,'Style','text',...
                'Position',[xpos,ypos,xsize,ysize],...
                'String','Voltage [V]: ',...
                'FontSize',12,...
                'HorizontalAlignment','right');
            ...
            obj.hDeflReadText = uicontrol(obj.hVsetGrp,'Style','text',...
                'Position',[xpos,ypos,xsize,ysize],...
                'String','Voltage [V]: ',...
                'FontSize',12,...
                'HorizontalAlignment','right');
            ...
            obj.hYsteerReadText = uicontrol(obj.hVsetGrp,'Style','text',...
                'Position',[xpos,ypos,xsize,ysize],...
                'String','Voltage [V]: ',...
                'FontSize',12,...
                'HorizontalAlignment','right');
            ...
            obj.hMassReadField = uicontrol(obj.hVsetGrp,'Style','edit',...
                'Position',[xpos,ypos,xsize,ysize],...
                'Enable','inactive',...
                'FontSize',12,...
                'HorizontalAlignment','right');
            ...
            obj.hExbReadField = uicontrol(obj.hVsetGrp,'Style','edit',...
                'Position',[xpos,ypos,xsize,ysize],...
                'Enable','inactive',...
                'FontSize',9,...
                'HorizontalAlignment','right');
            ...
            obj.hEsaReadField = uicontrol(obj.hVsetGrp,'Style','edit',...
                'Position',[xpos,ypos,xsize,ysize],...
                'Enable','inactive',...
                'FontSize',9,...
                'HorizontalAlignment','right');
            ...
            obj.hDeflReadField = uicontrol(obj.hVsetGrp,'Style','edit',...
                'Position',[xpos,ypos,xsize,ysize],...
                'Enable','inactive',...
                'FontSize',9,...
                'HorizontalAlignment','right');
            ...
            obj.hYsteerReadField = uicontrol(obj.hVsetGrp,'Style','edit',...
                'Position',[xpos,ypos,xsize,ysize],...
                'Enable','inactive',...
                'FontSize',9,...
                'HorizontalAlignment','right');
            ...
            obj.hMassSetText = uicontrol(obj.hVsetGrp,'Style','text',...
                'Position',[xpos,ypos,xsize,ysize],...
                'String','Vset [V]: ',...
                'FontSize',12,...
                'HorizontalAlignment','right');

            ypos = ystart-ysize-ygap;
            
            obj.hExbSetText = uicontrol(obj.hVsetGrp,'Style','text',...
                'Position',[xpos,ypos,xsize,ysize],...
                'String','Vset [V]: ',...
                'FontSize',12,...
                'HorizontalAlignment','right');
            ...
            obj.hEsaSetText = uicontrol(obj.hVsetGrp,'Style','text',...
                'Position',[xpos,ypos,xsize,ysize],...
                'String','Vset [V]: ',...
                'FontSize',12,...
                'HorizontalAlignment','right');
            ...
            obj.hDeflSetText = uicontrol(obj.hVsetGrp,'Style','text',...
                'Position',[xpos,ypos,xsize,ysize],...
                'String','Vset [V]: ',...
                'FontSize',12,...
                'HorizontalAlignment','right');
            ...
            obj.hYsteerSetText = uicontrol(obj.hVsetGrp,'Style','text',...
                'Position',[xpos,ypos,xsize,ysize],...
                'String','Vset [V]: ',...
                'FontSize',12,...
                'HorizontalAlignment','right');
            ...
            obj.hMassSetField = uicontrol(obj.hVsetGrp,'Style','edit',...
                'Position',[xpos,ypos,xsize,ysize],...
                'FontSize',12,...
                'HorizontalAlignment','right');
            ...
            obj.hExbSetField = uicontrol(obj.hVsetGrp,'Style','edit',...
                'Position',[xpos,ypos,xsize,ysize],...
                'FontSize',12,...
                'HorizontalAlignment','right');
            ...
            obj.hEsaSetField = uicontrol(obj.hVsetGrp,'Style','edit',...
                'Position',[xpos,ypos,xsize,ysize],...
                'FontSize',12,...
                'HorizontalAlignment','right');
            ...
            obj.hDeflSetField = uicontrol(obj.hVsetGrp,'Style','edit',...
                'Position',[xpos,ypos,xsize,ysize],...
                'FontSize',12,...
                'HorizontalAlignment','right');
            ...
            obj.hYsteerSetField = uicontrol(obj.hVsetGrp,'Style','edit',...
                'Position',[xpos,ypos,xsize,ysize],...
                'FontSize',12,...
                'HorizontalAlignment','right');
            ...
            obj.hMassSetBtn = uicontrol(obj.hVsetGrp,'Style','pushbutton',...
                'Position',[xpos,ypos,xsize,ysize],...
                'String','SET',...
                'FontWeight','bold',...
                'FontSize',12,...
            ...
            obj.hExbSetBtn = uicontrol(obj.hVsetGrp,'Style','pushbutton',...
                'Position',[xpos,ypos,xsize,ysize],...
                'String','SET',...
                'FontWeight','bold',...
                'FontSize',12,...
            ...
            obj.hEsaSetBtn = uicontrol(obj.hVsetGrp,'Style','pushbutton',...
                'Position',[xpos,ypos,xsize,ysize],...
                'String','SET',...
                'FontWeight','bold',...
                'FontSize',12,...
            ...
            obj.hDeflSetBtn = uicontrol(obj.hVsetGrp,'Style','pushbutton',...
                'Position',[xpos,ypos,xsize,ysize],...
                'String','SET',...
                'FontWeight','bold',...
                'FontSize',12,...
            ...
            obj.hYsteerSetBtn = uicontrol(obj.hVsetGrp,'Style','pushbutton',...
                'Position',[xpos,ypos,xsize,ysize],...
                'String','SET',...
                'FontWeight','bold',...
                'FontSize',12,...
            ...
            % axis function [left bottom width height
            
            hAxes = axes('units', 'normalized',...
                'position', [0 0 1 1]);
            uistack(hAxes, 'bottom')
            system_layout = imread('gui_bkg.png');
            hImage = imagesc(system_layout);
            colormap gray
            set(hAxes, 'handlevisibility', 'off',...
                'visible', 'off')
        
            
         % pressure read text boxes overlayed on figure
           obj.hBeamlineP = uicontrol(obj.hFigure,'Style','text',...
                'Position',[580,445,160,20],...
                'String','BEAMLINE PRESSURE:',...
                'FontSize',14,...
                'FontWeight','bold',...
                'HorizontalAlignment','left');
           obj.hP1ReadField = uicontrol(obj.hFigure,'Style','edit',...
                'Position',[605,425,xsize,ysize],...
                'Enable','inactive',...
                'FontSize',12,...
                'HorizontalAlignment','right');
           obj.hBeamlinePunit = uicontrol(obj.hFigure,'Style','text',...
                'Position',[690,425,25,20],...
                'String','torr',...
                'FontSize',14,...
                'HorizontalAlignment','left'); 
            
           obj.hChamberP = uicontrol(obj.hFigure,'Style','text',...
                'Position',[875,515,160,20],...
                'String','CHAMBER PRESSURE:',...
                'FontSize',14,...
                'FontWeight','bold',...
                'HorizontalAlignment','left');
           obj.hP2ReadField = uicontrol(obj.hFigure,'Style','edit',...
                'Position',[900,495,xsize,ysize],...
                'Enable','inactive',...
                'FontSize',12,...
                'HorizontalAlignment','right');
           obj.hChamberPunit = uicontrol(obj.hFigure,'Style','text',...
                'Position',[985,495,25,20],...
                'String','torr',...
                'FontSize',14,...
                'HorizontalAlignment','left'); 
           

           obj.hRoughlineP = uicontrol(obj.hFigure,'Style','text',...
                'Position',[530,315,170,20],...
                'String','ROUGHLINE PRESSURE:',...
                'FontSize',14,...
                'FontWeight','bold',...
                'HorizontalAlignment','left');
           obj.hP2ReadField = uicontrol(obj.hFigure,'Style','edit',...
                'Position',[560,295,xsize,ysize],...
                'Enable','inactive',...
                'FontSize',12,...
                'HorizontalAlignment','right');
           obj.hChamberPunit = uicontrol(obj.hFigure,'Style','text',...
                'Position',[645,295,25,20],...
                'String','torr',...
                'FontSize',14,...
                'HorizontalAlignment','left'); 
